...
class Customexercisedaydetail extends StatefulWidget {
  final String docId;
  final int dayindex;

  const Customexercisedaydetail(
      {Key? key, required this.docId, required this.dayindex})
      : super(key: key);

  @override
  State<Customexercisedaydetail> createState() =>
      _CustomexercisedaydetailState();
}

class _CustomexercisedaydetailState extends State<Customexercisedaydetail> {
