...
class Trainerexercisedaydetail extends StatefulWidget {
  ...
  const Trainerexercisedaydetail(
      {Key? key, required this.docId, required this.dayindex})
      : super(key: key);

  @override
  State<Trainerexercisedaydetail> createState() =>
      _TrainerexercisedaydetailState();
}

class _TrainerexercisedaydetailState extends State<Trainerexercisedaydetail> {
